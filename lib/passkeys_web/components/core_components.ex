defmodule PasskeysWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PasskeysWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PasskeysWeb.Gettext, "errors", msg, opts)
    # end
